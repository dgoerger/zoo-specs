...
# Depends:   
# Imports:   R-stats R-grDevices R-ggplot2 R-gridExtra
# Suggests:  R-hexbin R-scales R-MASS R-knitr R-dichromat R-colorspace R-rasterVis R-httr R-mapproj
# LinkingTo:
# Enhances:



Requires:         R-stats R-grDevices R-ggplot2 R-gridExtra 
Requires:         R-hexbin R-scales R-MASS R-knitr R-dichromat R-colorspace R-rasterVis R-httr R-mapproj 
BuildRequires:    R-devel tex(latex) 
BuildRequires:    R-stats R-grDevices R-ggplot2 R-gridExtra 
BuildRequires:    R-hexbin R-scales R-MASS R-knitr R-dichromat R-colorspace R-rasterVis R-httr R-mapproj 
